...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-50 flex h-screen w-72.5 flex-col overflow-y-hidden bg-[#318134] duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-[#6abf6d] dark:hover:bg-meta-4 ${
                    pathname.includes('/admin/loan-approval') &&
                    'bg-[#62bd66] dark:bg-meta-4'
                  }`}
                >
                  <Wallet />
