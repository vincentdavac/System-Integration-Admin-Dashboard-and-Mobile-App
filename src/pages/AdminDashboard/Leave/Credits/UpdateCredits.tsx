...
export default function UpdateCreditsModal({ onClose }: UpdateCreditsProps) {
  return (
      ...
      <div className="bg-white rounded-lg shadow-lg w-full max-w-4xl max-h-[90vh] flex flex-col">
        ...
        <div className="px-5 py-6 flex-1 overflow-y-auto bg-gray-50 font-serif leading-relaxed text-gray-800">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="bg-white p-4 mb-2 border rounded-lg shadow-sm">
              <label className="text-sm text-gray-500">Employee Credits</label>
              <input
                type="number"
