...
const OfficialBusiness = ({ alertsRef }: Props) => {
  ...
  return (
    <>
      <Breadcrumb pageName="Official Business" />
              ...
              {paginatedRequests.length > 0 ? (
                paginatedRequests.map((req, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-3">{req.accountNo}</td>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
          <div className="bg-white rounded-lg shadow-lg w-full max-w-lg max-h-[90vh] overflow-y-auto flex flex-col">
            ...
            <div className="px-6 py-4 flex-1 overflow-y-auto space-y-2">
              ...
              <p>
                <strong>Employee ID:</strong> {selectedRow.accountNo}
              </p>
              <p>
              ...
              <p>
                <strong>Attachment:</strong> {selectedRow.attachment || '—'}
              </p>

              <h3 className="font-bold border-b pb-1 mt-4 mb-2">
                Leave Request Information
              </h3>
              <p>
                <strong>Leave Type:</strong> {selectedRow.leaveType}
              </p>
              <p>
                <strong>Start Date:</strong> {selectedRow.startDate}
              </p>
              <p>
                <strong>End Date:</strong> {selectedRow.endDate}
              </p>
              <p>
                <strong>Total Days:</strong> {selectedRow.totalDays}
              </p>
              <p>
              ...
              <p>
                <strong>Reviewed By:</strong> {selectedRow.reviewedBy}
              </p>
              <p>
                <strong>Approval Date:</strong> {selectedRow.approvalDate}
              </p>
